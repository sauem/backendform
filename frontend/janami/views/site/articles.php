            ...
            <aside id="sidebar" class="col-lg-4">
                ...
                <div id="search-field" class="sidebar-div mb-50">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Tìm kiếm..." aria-label="Search" aria-describedby="search-field">
                ...
                <div class="blog-categories sidebar-div mb-50">
                    ...
                    <ul class="blog-category-list txt-color-05 clearfix">
                        <li><a href="#">Bella the sun</a> <span>(9)</span></li>
                        <li><a href="#">Bihaku</a> <span>(5)</span></li>
                        <li><a href="#">Ketoskin</a> <span>(13)</span></li>
                        <li><a href="#">Skinicer</a> <span>(12)</span></li>
                        <li><a href="#">Skinmd</a> <span>(12)</span></li>
                    </ul>
