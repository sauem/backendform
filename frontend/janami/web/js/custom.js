...
$(document).ready(function () {
    ...
    /*----------------------------------------------------*/
    const videoId = $('.video-popup1').attr('href');
    $('.video-popup1').magnificPopup({
        ...
        iframe: {
            patterns: {
                youtube: {
                    index: 'youtube.com',
                    src: videoId ? videoId : 'https://www.youtube.com/embed/11mVSlEK9m4'
                }
            }
        }
    });
    ...
    /*----------------------------------------------------*/
    const videoId2 = $('.video-popup2').attr('href');
    ...
    $('.video-popup2').magnificPopup({
        ...
        iframe: {
            patterns: {
                youtube: {
                    index: 'youtube.com',
                    src: videoId2 ? videoId2 : 'https://www.youtube.com/embed/5Pe3Kk4ydfc'
                }
            }
        }
    });
