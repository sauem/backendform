...
class SiteController extends BaseController
{
    ...
    public function authRequired()
    {
        return [
            ...
            'member', 'setting-content', 'technology', 'brouchure','page','page-create'
    ...
    {
        return $this->render('technology.blade');

    }

    public function actionBrouchure()
    {
        return $this->render('brouchure.blade');
    }

    public function actionPage()
    {
        return $this->render("page-index.blade");
    }
