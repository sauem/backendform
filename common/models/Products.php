...
class Products extends BaseModel
{
    ...
    {
        return ['avatar', 'archives','banner',
            'defaultArchive',
            'meta', 'media_id', 'thumbs', 'thumbnails', 'meta']; // TODO: Change the autogenerated stub
    }
    ...
    public function beforeSave($insert)
    {
        if (!empty($this->relations)) {
            $this->relations = json_encode($this->relations, JSON_UNESCAPED_UNICODE);
        }
    ...
    static function getRelated($relations = [])
    {
        if (empty($relations)) {
            return [];
        }
        return Products::find()->where(['id' => $relations])->all();
    }
